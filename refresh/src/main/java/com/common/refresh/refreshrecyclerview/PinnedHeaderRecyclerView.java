...
public class PinnedHeaderRecyclerView extends RecyclerView {
     ...
     */
    public interface PinnedHeaderStateControler {
    ...
    private PinnedHeaderStateControler mAdapter;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mAdapter = (PinnedHeaderStateControler)adapter;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mHeaderView != null) {
            ...
            if(getLayoutManager() instanceof LinearLayoutManager){
                ...
                configureHeaderView(((GridLayoutManager)getLayoutManager()).findFirstVisibleItemPosition());
            }
        }
    }
    ...
    public void configureHeaderView(int position) {
        ...
        switch (state) {
            case PinnedHeaderStateControler.PINNED_HEADER_GONE: {
                mHeaderViewVisible = false;
                break;
            }

            case PinnedHeaderStateControler.PINNED_HEADER_VISIBLE: {
            ...
            case PinnedHeaderStateControler.PINNED_HEADER_PUSHED_UP: {
