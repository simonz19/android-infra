...
public class OKProgressRequestBody extends RequestBody {
    ...
    public OKProgressRequestBody(File file, ProgressListener progressListener) {
        this.mRequestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
        this.mProgressListener = progressListener;
    }

    public OKProgressRequestBody(RequestBody requestBody, ProgressListener progressListener) {
