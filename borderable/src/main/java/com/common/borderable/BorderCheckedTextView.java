...
/**
 * 支持四边作图和提示圆点的 {@link CheckedTextView}
 * 
 * @author Wx
 * 
 */
public class BorderCheckedTextView extends AppCompatCheckedTextView implements
		IBadgeView, IBorderView {
	...
	public BorderCheckedTextView(Context context, AttributeSet attrs,
                                 int defStyle) {
	...
	public BorderCheckedTextView(Context context) {
		super(context, null);
	}
