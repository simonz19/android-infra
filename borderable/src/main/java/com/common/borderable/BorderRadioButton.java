 ...
 * @author W, x
 */
public class BorderRadioButton extends AppCompatRadioButton implements IBadgeView,
        IBorderView {
    ...
    public BorderRadioButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.BorderableViews_borders) {
                ...
                setBorderColor(attributes.getColor(attr, Color.TRANSPARENT));
                    ...
                    attr == R.styleable.BorderableViews_borderBottom) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawables != null) { //解决drawable不能居中的问题
            //第一个是left
        ...
        if (borderRightColorList != null || borderRightDrawable != null) {
            ...
            if (borderRightDrawable != null) {
                ...
                borderRightDrawable.setBounds(l, t + borderRightPaddingTop, r,
                        b - borderRightPaddingBottom);
