...
public class StringUtils {
     ...
     * @return
     */
    public static String nullStrToDefault(String value, String defaultStr) {
     ...
     * @date2015年5月19日
     */
    public static String retIsNotBlank(String value) {
     ...
     * @return
     */
    public static String concatStr(String str1, String str2, String concat) {
